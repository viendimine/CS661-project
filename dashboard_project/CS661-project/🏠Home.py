...
/* 🧱 Make top Streamlit app header (where "Deploy" button is) black */
header[data-testid="stHeader"] {
    background-color: black !important;
}

/* 🏁 Remove extra margin from top of page */
.block-container {
    padding-top: 1rem !important;
}

/* 🔳 Force overall background to be black and text white */
